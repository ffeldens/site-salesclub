  ...
  proximasEdicoes: [
    {
      ...
      inscricaoUrl: 'https://lp.salesclub.com.br/sales-club-pelo-brasil-cafe/londrina-pr',
    },
    {
      ...
      status: 'Em breve',
      descricao: 'Formato em definição — inscrições em breve.',
    },
    { cidade: 'Rio de Janeiro', uf: 'RJ', data: '1º trimestre de 2027', status: 'Em breve' },
    { cidade: 'Itajaí', uf: 'SC', data: '1º trimestre de 2027', status: 'Em breve' },
    { cidade: 'Boa Vista', uf: 'RR', data: '1º trimestre de 2027', status: 'Em breve' },
  ] as Edicao[],
  ultimasEdicoes: [
    { cidade: 'São Luís', uf: 'MA', data: '4 de setembro', local: 'Profissionalle Hotel' },
    { cidade: 'Teresina', uf: 'PI', data: '2 de setembro', local: 'Restaurante Santa Grelha' },
    { cidade: 'Belém', uf: 'PA', data: '26 de agosto', local: 'Tio Armênio' },
