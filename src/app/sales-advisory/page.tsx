...
// TODO(conteúdo): validar a descrição e o formato do Sales Advisory com o cliente.
export const metadata: Metadata = buildMetadata({
  title: 'Sales Advisory — conselho consultivo de vendas',
  description:
    'O Sales Advisory é o conselho consultivo de vendas do Sales Club: acompanhamento estratégico recorrente da sua área comercial por especialistas.',
  path: '/sales-advisory',
})

export default function SalesAdvisoryPage() {
  return (
    <PageShell whatsappMessage="Olá! Quero saber mais sobre o Sales Advisory.">
      <HeroInstitucional
        eyebrow="Conselho consultivo"
        title="Sales Advisory: um conselho de vendas para a sua empresa"
      ...
      <Section>
        <div className="max-w-3xl">
          ...
          <AnswerBlock>
            O Sales Advisory é o conselho consultivo de vendas do Sales Club: um grupo de especialistas
            que acompanha a sua operação comercial de forma recorrente, ajudando a tomar decisões de
      ...
      <Beneficios
        ...
        title="O que o Sales Advisory entrega"
        items={[
      ...
      <CTASection
        ...
        description="Converse com o time do Sales Club e entenda como o Sales Advisory pode acompanhar a sua operação."
        primaryCta={{ label: 'Falar com especialista', href: '/contato' }}
      />
    </PageShell>
  )
